...
void RenderManager::renderScene() {
	...
	//	glm::vec3(0.0f, 2.0f, 8.0f), // The position of your camera, in world space
	...
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(ModelVertex), (const GLvoid*)12);
	...
	//std::cout << renderInstance->vertexListSize << std::endl;
